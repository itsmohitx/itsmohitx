...
export default function RegionsIndex() {
  return (
    <div className="mx-auto max-w-wide px-5 py-10 sm:px-8">
      <PageNav crumbs={[{ label: "Home", href: "/" }, { label: "Regions" }]} backHref="/" />
      ...
      <header className="mb-10 max-w-2xl">
        ...
        <p className="reading mt-5 text-lg">
          Five regions of one worldview. The edges between them carry the argument: name where
          two regions touch and you usually find the essay.
        </p>
      </header>

      {/* The living map on wide screens; the same content as rows everywhere else. */}
      <RegionsMap />
    </div>
  );
}
